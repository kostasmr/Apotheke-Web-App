...
class FileUpload {
    ...
    get basicButtonLabel() {
        ...
        return (_a = this.uploadLabel) !== null && _a !== void 0 ? _a : this.files[0].name;
    }
    ngAfterContentInit() {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.8", ngImport: i0, type: FileUpload, decorators: [{
    ...
    `, changeDetection: ChangeDetectionStrategy.OnPush, encapsulation: ViewEncapsulation.None, host: {
        ...
        return [{ type: Document, decorators: [{
                        ...
                        type: Inject,
                        args: [PLATFORM_ID]
                    }] }, { type: i0.Renderer2 }, { type: i0.ElementRef }, { type: i1.DomSanitizer }, { type: i0.NgZone }, { type: i2.HttpClient }, { type: i0.ChangeDetectorRef }, { type: i3.PrimeNGConfig }];
    }, propDecorators: { name: [{
                type: Input
            }], url: [{
                type: Input
